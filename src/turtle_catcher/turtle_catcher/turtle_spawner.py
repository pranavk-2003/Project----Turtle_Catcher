...
class turtleSpawner(Node): # MODIFY NAME
    def __init__(self):
        super().__init__("turtle_spawnner") # MODIFY NAME
        self.declare_parameter("spawn_frequency",1.0)
        
        self.spawn_frequency=self.get_parameter(
            "spawn_frequency").value
        self.turtle_name_prefix="turtle"
        self.turtle_counter=0
        self.alive_turtles_=[]
        self.alive_turtle_pub=self.create_publisher(TurtleArray,"alive_turtles",10)
    ...
    def Alive_turtles(self):
        ...
        self.alive_turtle_pub.publish(msg)
